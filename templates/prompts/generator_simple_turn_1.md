...
Implement the valid fixes reliably. Do not introduce bad code, new errors, unintended behavior, regressions, tech debt, or clear unnecessary complexity while fixing the review findings.
